...
namespace smartFunds.Data.Migrations
{
    ...
    [Migration("20190128083423_AddContactBaseTable")]
    partial class AddContactBaseTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("smartFunds.Data.ContactBase.Models.ContactBaseCountry", b =>
                {
                    ...
                    b.ToTable("contactbase.Countries");
                });

            modelBuilder.Entity("smartFunds.Data.ContactBase.Models.ContactBaseLocality", b =>
                {
                    b.Property<int>("Id");
                    ...
                    b.ToTable("contactbase.Localities");
                });

            modelBuilder.Entity("smartFunds.Data.ContactBase.Models.ContactBaseRegion", b =>
                {
                    b.Property<int>("Id");
                    ...
                    b.ToTable("contactbase.Regions");
                });

            modelBuilder.Entity("smartFunds.Data.ContactBase.Models.Sublocality", b =>
                {
                    b.Property<int>("Id");
                    ...
                    b.ToTable("contactbase.Sublocalities");
                });
            ...
            modelBuilder.Entity("smartFunds.Data.ContactBase.Models.ContactBaseCountry", b =>
                {
                    b.HasOne("smartFunds.Data.ContactBase.Models.ContactBaseRegion", "Region")
                        .WithMany()
            ...
            modelBuilder.Entity("smartFunds.Data.ContactBase.Models.ContactBaseLocality", b =>
                {
                    b.HasOne("smartFunds.Data.ContactBase.Models.ContactBaseCountry", "Country")
                        .WithMany("Localities")
            ...
            modelBuilder.Entity("smartFunds.Data.ContactBase.Models.Sublocality", b =>
                {
                    b.HasOne("smartFunds.Data.ContactBase.Models.ContactBaseLocality", "Locality")
            ...
            modelBuilder.Entity("smartFunds.Data.Models.EventSublocality", b =>
                {
                    ...
                    b.HasOne("smartFunds.Data.ContactBase.Models.Sublocality", "Sublocality")
                        .WithMany()
                        .HasForeignKey("SublocalityId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
