...
{
    public interface IFundSellFeeRepository : IRepository<FundSellFee>
    {
    }

    public class FundSellFeeRepository : GenericRepository<FundSellFee>, IFundSellFeeRepository
    {
        private readonly smartFundsDbContext _smartFundsDbContext;

        public FundSellFeeRepository(smartFundsDbContext smartFundsDbContext, IOptions<smartFundsRedisOptions> redisConfigurationOptions
