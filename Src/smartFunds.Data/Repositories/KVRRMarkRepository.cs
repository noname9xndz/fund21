...
{
    public interface IKVRRMarkRepository : IRepository<KVRRMark>
    {
        
    }

    public class KVRRMarkRepository : GenericRepository<KVRRMark>, IKVRRMarkRepository
    {
        private readonly smartFundsDbContext _smartFundsDbContext;

        public KVRRMarkRepository(smartFundsDbContext smartFundsDbContext, IOptions<smartFundsRedisOptions> redisConfigurationOptions
