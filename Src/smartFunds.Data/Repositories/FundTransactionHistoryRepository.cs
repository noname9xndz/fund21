...
{
    public interface IFundTransactionHistoryRepository : IRepository<FundTransactionHistory>
    {
    }

    public class FundTransactionHistoryRepository : GenericRepository<FundTransactionHistory>, IFundTransactionHistoryRepository
    {
