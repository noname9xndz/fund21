...
{
    public interface IMemberRepository : IReadOnlyRepository<Member> {
    }
    public class MemberRepository : ReadOnlyGenericRepository<Member>, IMemberRepository
    {
        private readonly smartFundsDbContext _smartFundsDbContext;
        public MemberRepository(smartFundsDbContext smartFundsDbContext, IOptions<smartFundsRedisOptions> redisConfigurationOptions
